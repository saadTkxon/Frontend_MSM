...
async function fetchAllReviews() {
    ...
    try {
        const response = await fetch(apiUrl, {
            ...
            body: JSON.stringify({}) // send empty object as JSON body
        });
...
//         } else {
//             firstImage = '/assets/misc/productItem1.png'; // default image
//         }
...
function displayReviews(reviewsData) {
    ...
    reviewsData.reviews.forEach(review => {
        ...
        if (review.review_image_1) {
            ...
            firstImage = '/msm_kosmetika_fin/assets/branding/logoOne.webp'; // default image
        }
